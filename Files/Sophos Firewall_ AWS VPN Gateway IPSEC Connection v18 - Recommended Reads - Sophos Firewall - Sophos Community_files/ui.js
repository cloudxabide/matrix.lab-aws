(function ($, global, undef) {
	...
	function initSearchPopup(context) {
		...
		function loadSearchFilters(context, scope) {
			var filters = [];
            filters.push({
			    key: 'kb', name: context.searchFilterDocumentName, searchParameter: '', searchValue: ''
			});
			filters.push({
			    key: 'Documentation', name: context.searchFilterArticleName, searchParameter: '', searchValue: ''
			});
