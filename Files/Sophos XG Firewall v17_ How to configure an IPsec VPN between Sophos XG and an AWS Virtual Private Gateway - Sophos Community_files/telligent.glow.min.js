(function(g,t){var w={val:function(c){return this.val(c)},disabled:function(c){typeof c!=="undefined"&&this.filter("input").each(function(){var d=g(this);if(!c&&e(d))j(d);else c&&!e(d)&&l(d)});return this.is("input:disabled")}},x=null,y=null,v=function(c){c=g.extend({},g.fn.glowColorSelector.defaults,c||{});if(y===null){x=g.telligent.glow.utility;y=p(c)}return this.each(function(){var d=g(this);d.css({backgroundColor:d&&d.val()?x.convertRgbColorToHtmlColor(x.convertHtmlColorToRgbColor(d.val())):"",
textAlign:"center",color:x.getContrastingHtmlColorForRgbColor(x.convertHtmlColorToRgbColor(d&&d.val()?x.convertRgbColorToHtmlColor(x.convertHtmlColorToRgbColor(d.val())):""))});e(d)?l(d):j(d)})},p=function(c){var d={blendImageUrl:c.blendImageUrl,hueBlendImageUrl:c.hueBlendImageUrl,moveStartX:null,moveStartY:null,elementMoveStartX:null,elementMoveStartY:null};c=g("<div></div>").css({width:"290px",padding:"2px",paddingLeft:"6px",borderStyle:"solid",borderWidth:"1px",borderColor:"#000000",backgroundColor:"#eeeeee",
...
function(a){f.hueCursorMouseMoveHandler(a);return false})},hueCursorMouseMoveHandler:function(k){k=d.elementMoveStartY+((typeof k.pageY!="undefined"?k.pageY:k.screenY)-d.moveStartY);if(k<0)k=0;if(k>255)k=255;d.hueSelectCursor.css({top:k+"px"});f.updateTemporaryValue()},endMoveTracking:function(){g(document).unbind("mouseup.glowColorSelector").unbind("mousemove.glowColorSelector")},clickValueSaturationHandler:function(k){x.getWindowInfo();var a=x.getElementInfo(d.selectBox);d.selectBoxCursor.css({left:k.pageX-
a.Left+"px",top:k.pageY-a.Top+"px"});f.updateTemporaryValue();f.cursorMouseDownHandler(k)},updateTemporaryValue:function(k){var a=parseInt(d.selectBoxCursor.css("left"),10),b=(255-parseInt(d.selectBoxCursor.css("top"),10))/255,h=(255-parseInt(d.hueSelectCursor.css("top"),10))*(360/255),m=x.convertHsvColorToRgbColor([h,1,255]);d.selectBoxBackground.css({backgroundColor:x.convertRgbColorToHtmlColor(m)});m=x.convertHsvColorToRgbColor([h,b,a]);a=x.convertRgbColorToHtmlColor(m);d.selectedColor.css({backgroundColor:a});
k||d.selectedColor.val(a);d.selectedColor.css({color:x.getContrastingHtmlColorForRgbColor(m)})},parseEnteredColor:function(){var k=x.convertRgbColorToHsvColor(x.convertHtmlColorToRgbColor(d.selectedColor.val()));d.selectBoxCursor.css({left:k[2]+"px",top:k[1]*-255+255+"px"});d.hueSelectCursor.css({top:k[0]/-(360/255)+255+"px"});f.updateTemporaryValue(true)},showColorSelector:function(k){d.popupPanel.glowPopUpPanel("hide");d.currentInput=k;d.popupPanel.glowPopUpPanel("show",d.currentInput);k=x.convertRgbColorToHsvColor(x.convertHtmlColorToRgbColor(d.currentInput.val()));
...
selectNoColor:function(){if(d.currentInput!==null){o(d.currentInput,"",true);try{d.currentInput.focus()}catch(k){}d.popupPanel.glowPopUpPanel("hide")}}};g.extend(d,f);return d},o=function(c,d,n){if(c){d=d?x.convertRgbColorToHtmlColor(x.convertHtmlColorToRgbColor(d)):"";var f=c.val()!=d;c.val(d).css({backgroundColor:c.val(),color:x.getContrastingHtmlColorForRgbColor(x.convertHtmlColorToRgbColor(c.val()))});f&&n&&c.trigger("change")}},l=function(c){c.unbind("click.glowColorSelector").unbind("keydown.glowColorSelector").css({cursor:"default"}).attr("disabled",
"disabled")},j=function(c){c.bind("click.glowColorSelector",function(){c.blur();y.showColorSelector(c);return false}).bind("keydown.glowColorSelector",function(d){if(d.keyCode!=9&&d.keyCode!=16){c.blur();y.showColorSelector(c);return false}else return true}).css({cursor:"pointer"}).removeAttr("disabled")},e=function(c){return c.is("input:disabled")};g.fn.glowColorSelector=function(c){if(c in w)return w[c].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof c==="object"||!c)return v.apply(this,
...
(function(g,t){var w={val:function(c){if(c===undefined){var d=g(this).data(x);if(d===null)return null;var n=d.internal.patternedTextBox.glowPatternedTextBox("getPatternValues"),f,k,a;if(d.settings.yearIndex>=0){f=parseInt(n[d.settings.yearIndex],10);if(isNaN(f))return null}else f=(new Date).getFullYear();if(d.settings.dayIndex>=0){a=parseInt(n[d.settings.dayIndex],10);if(isNaN(a))return null}else a=(new Date).getDate();if(d.settings.monthIndex>=0){k=o(d,n[d.settings.monthIndex])-1;if(isNaN(k))return null}else k=
(new Date).getMonth();c=new Date(f,k,a);if(d.settings.hourIndex>=0){f=parseInt(n[d.settings.hourIndex],10);if(isNaN(f))return null;else d.settings.amPmIndex>=0?c.setHours(l(d,f,n[d.settings.amPmIndex])):c.setHours(l(d,f,-1))}if(d.settings.minuteIndex>=0){d=parseInt(n[d.settings.minuteIndex],10);if(isNaN(d))return null;else c.setMinutes(d)}return c}else return this.each(function(){var b=g(this).data(x),h=b.internal.patternedTextBox.glowPatternedTextBox("getPatternValues");if(b.settings.yearIndex>=
...
0){m=b.settings.amPmIndex;q=c.getHours();q=b.settings.amPmIndex>-1?q>=12?b.internal.patternedTextBox.glowPatternedTextBox("getPatternValueOption",b.settings.amPmIndex,1):b.internal.patternedTextBox.glowPatternedTextBox("getPatternValueOption",b.settings.amPmIndex,0):"";h[m]=q}b.internal.patternedTextBox.glowPatternedTextBox("setPatternValues",h)})},disabled:function(c){if(c===undefined){var d=this.data(x);if(d)return d.internal.patternedTextBox.glowPatternedTextBox("disabled");return false}else return this.each(function(){var n=
g(this).data(x);n.internal.patternedTextBox.glowPatternedTextBox("disabled",c);if(n.internal.popupButton)c?n.internal.popupButton.attr("disabled","disabled").unbind("click"+y):n.internal.popupButton.removeAttr("disabled").unbind("click"+y).bind("click"+y,function(){var f=w.val.apply(n.internal.state);f||(f=new Date);n.internal.currentDate=f;n.internal.currentMonth=f.getMonth()+1;n.internal.currentYear=f.getFullYear();j(n);n.internal.popupPanel.glowPopUpPanel("show",n.internal.popupButton)})})}},x=
"_glowDateTimeSelector",y=".glowDateTimeSelector",v=function(c){return this.each(function(){var d={settings:g.extend({},g.fn.glowDateTimeSelector.defaults,c||{}),internal:{state:g(this),initialized:false,patternedTextBox:null,popupButton:null,popupPanel:null,currentDate:new Date,currentYear:(new Date).getFullYear(),currentMonth:(new Date).getMonth()+1}};g(this).data(x,d);t.setTimeout(function(){p(d)},9)})},p=function(c){var d=null;if(c.settings.parseDateOnLoad)try{var n=c.internal.state.val();if(n.length>
0){n=Date.parse(n);if(!isNaN(n)){d=new Date(n);c.internal.state.val("")}}}catch(f){}c.internal.patternedTextBox=c.internal.state.glowPatternedTextBox({pattern:c.settings.pattern,allowBlanks:c.settings.allowBlankvalue,blankCharacter:"_",cssClass:"glow-datetimeselector",onValidation:function(k,a,b,h){if(!(!c.internal.initialized||c.settings.monthIndex<0||c.settings.dayIndex<0)){k=o(c,a[c.settings.monthIndex]);var m=parseInt(a[c.settings.dayIndex],10),q=-1;if(c.internal.yearIndex>=0)q=parseInt(a[c.settings.yearIndex],
10);if(!(isNaN(k)||isNaN(m))){var r=a[c.settings.dayIndex];if(k==2)if(!isNaN(q)&&q>-1&&(q%4===0&&q%100!==0||q%400===0)){if(m>29)r=h==c.settings.dayIndex&&b=="next"?"01":"29"}else{if(m>28)r=h==c.settings.dayIndex&&b=="next"?"01":"28"}else if((k==4||k==6||k==9||k==11)&&m>30)r=h==c.settings.dayIndex&&b=="next"?"01":"30";a[c.settings.dayIndex]=r}}return a}}).bind("glowPatternedTextBoxChange"+y,function(){c.internal.state.trigger("glowDateTimeSelectorChange")});if(c.settings.showPopup&&c.internal.state){c.internal.popupButton=
c.settings.calendarButtonImageUrl?g('<img style="border: 1px solid #ccc; padding: 2px; align: top; margin-left: 2px; background-color: #eee;" />').css({borderTopColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"border-top-color","borderTopColor","#999"),borderLeftColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"border-left-color","borderLeftColor","#999"),borderRightColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"border-right-color","borderRightColor",
"#999"),borderBottomColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"border-bottom-color","borderBottomColor","#999"),backgroundColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"background-color","backgroundColor","#fff")}).attr("src",c.settings.calendarButtonImageUrl).addClass("glow-datetimeselector-calendarbutton").insertAfter(c.internal.state):g('<input type="button" />').val(c.settings.calendarButtonText).addClass(c.settings.calendarButtonCssClass).addClass("glow-datetimeselector-calendarbutton").insertAfter(c.internal.state);
c.internal.popupPanel=g("<div></div>").insertAfter(c.internal.popupButton).glowPopUpPanel({cssClass:"",position:"updown",zIndex:3E5,hideOnDocumentClick:true})}w.disabled.apply(c.internal.state,[c.internal.patternedTextBox.glowPatternedTextBox("disabled")]);c.internal.initialized=true;d!==null&&w.val.apply(c.internal.state,[d])},o=function(c,d){if(d===undefined)return parseInt("NaN",10);if(isNaN(parseInt(d,10))){var n=c.internal.patternedTextBox.glowPatternedTextBox("getPatternValueOptionIndex",c.settings.monthIndex,
d);if(n!==undefined)return n+1;return parseInt("NaN",10)}else return parseInt(d,10)},l=function(c,d,n){d=parseInt(d,10);if(isNaN(d))return d;if(n!==undefined&&c.settings.amPmIndex>-1){c=c.internal.patternedTextBox.glowPatternedTextBox("getPatternValueOptionIndex",c.settings.amPmIndex,n);if(c===0){if(d==12)d=0}else if(c===1)if(d!=12)d+=12}return d},j=function(c){if(c.internal.popupPanel){c.internal.popupPanel.glowPopUpPanel("empty");var d=g("<div></div>").css({borderTopWidth:"1px",borderLeftWidth:"1px",
borderRightWidth:"1px",borderBottomWidth:"1px",borderTopStyle:"solid",borderLeftStyle:"solid",borderRightStyle:"solid",borderBottomStyle:"solid",borderTopColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"border-top-color","borderTopColor","#999"),borderLeftColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"border-left-color","borderLeftColor","#999"),borderRightColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"border-right-color","borderRightColor",
"#999"),borderBottomColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"border-bottom-color","borderBottomColor","#999"),fontFamily:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"font-family","fontFamily","Arial, Helvetica"),backgroundColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"background-color","backgroundColor","#fff"),padding:"2px",fontSize:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"font-size","fontSize","9pt"),color:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,
"color","color","#000")}),n=g("<table></table>").attr("cellPadding",0).attr("cellSpacing",0).css({borderWidth:"0px"}).appendTo(d);n=g("<tbody></tbody>").appendTo(n);var f=g("<tr></tr>"),k=g("<td></td>").css({textAlign:"center",padding:"2px",cursor:"pointer"}).bind("click"+y,function(r){if(c.settings.dayIndex>-1){c.internal.currentMonth--;if(c.internal.currentMonth<1){c.internal.currentMonth=12;c.internal.currentYear>0&&c.internal.currentYear--}}else c.internal.currentYear--;j(c);r.stopPropagation();
return false}).appendTo(f);g("<div></div>").addClass(c.settings.previousButtonCssClass).html("&lt;").appendTo(k);k=g("<td></td>").css({textAlign:"center",padding:"2px",fontWeight:"bold",fontSize:"90%"}).appendTo(f);c.settings.dayIndex>-1?k.attr("colSpan",5).html(c.settings.monthNames[c.internal.currentMonth-1]+" "+c.internal.currentYear):k.html(c.internal.currentYear);k=g("<td></td>").css({textAlign:"center",padding:"2px",cursor:"pointer"}).bind("click"+y,function(r){if(c.settings.dayIndex>-1){c.internal.currentMonth++;
if(c.internal.currentMonth>12){c.internal.currentMonth=1;c.internal.currentYear<9999&&c.internal.currentYear++}}else c.internal.currentYear++;j(c);r.stopPropagation();return false}).appendTo(f);g("<div></div>").addClass(c.settings.nextButtonCssClass).html("&gt;").appendTo(k);n.append(f);if(c.settings.dayIndex>-1){f=g("<tr></tr>");for(var a=0;a<c.settings.dayNames.length;a++)k=g("<td></td>").html(c.settings.dayNames[a]).css({textAlign:"center",padding:"2px",fontWeight:"bold",borderBottomWidth:"1px",
borderBottomStyle:"solid",fontSize:"90%",width:"14%",borderBottomColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"border-bottom-color","borderBottomColor","#999")}).appendTo(f);n.append(f);a=new Date(c.internal.currentYear,c.internal.currentMonth-1,1);f=g("<tr></tr>");for(var b=0,h=5;b<a.getDay();){k=g("<td></td>").html("&nbsp;").css({fontSize:"90%",padding:"2px",textAlign:"center",width:"14%"}).appendTo(f);b++}var m=31;if(c.internal.currentMonth==2)m=!isNaN(c.internal.currentYear)&&
c.internal.currentYear>-1&&(c.internal.currentYear%4===0&&c.internal.currentYear%100!==0||c.internal.currentYear%400===0)?29:28;else if(c.internal.currentMonth==4||c.internal.currentMonth==6||c.internal.currentMonth==9||c.internal.currentMonth==11)m=30;var q=-1;if(c.internal.currentMonth==c.internal.currentDate.getMonth()+1&&c.internal.currentYear==c.internal.currentDate.getFullYear())q=c.internal.currentDate.getDate();for(a=1;a<=m;a++){b++;k=g("<td></td>").html(a).css({textAlign:"center",padding:"2px",
fontSize:"90%",cursor:"pointer",width:"14%"}).bind("click"+y,g.telligent.glow.utility.makeBoundFunction(e,null,[c,a])).bind("mouseover"+y,function(r){g(r.target).css({color:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"background-color","backgroundColor","#fff"),backgroundColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"color","color","#000")})}).bind("mouseout"+y,function(r){g(r.target).css({color:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,
"color","color","#000"),backgroundColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"background-color","backgroundColor","#fff")})});a==q&&k.css({padding:"1px",borderTopWidth:"1px",borderLeftWidth:"1px",borderRightWidth:"1px",borderBottomWidth:"1px",borderTopStyle:"solid",borderLeftStyle:"solid",borderRightStyle:"solid",borderBottomStyle:"solid",borderTopColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"color","color","#000"),borderLeftColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,
"color","color","#000"),borderRightColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"color","color","#000"),borderBottomColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"color","color","#000")});f.append(k);if(b==7){b=0;n.append(f);f=g("<tr></tr>");h--}}for(;b<7;){k=g("<td></td>").html("&nbsp;").css({fontSize:"90%",padding:"2px",textAlign:"center",width:"14%"}).appendTo(f);b++}for(n.append(f);h>0;){h--;f=g("<tr></tr>");for(a=0;a<7;a++)k=g("<td></td>").html("&nbsp;").css({fontSize:"90%",
padding:"2px",textAlign:"center",width:"14%"}).appendTo(f);n.append(f)}}else{b=-1;if(c.internal.currentYear==c.internal.currentDate.getFullYear())b=c.internal.currentDate.getMonth();for(a=0;a<12;a++){if(a%3==0){f=g("<tr></tr>");n.append(f)}k=g("<td></td>").html(c.settings.monthNames[a]).css({textAlign:"center",padding:"2px",fontSize:"90%",cursor:"pointer",width:"14%"}).bind("click"+y,g.telligent.glow.utility.makeBoundFunction(e,null,[c,a])).bind("mouseover"+y,function(r){g(r.target).css({color:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,
"background-color","backgroundColor","#fff"),backgroundColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"color","color","#000")})}).bind("mouseout"+y,function(r){g(r.target).css({color:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"color","color","#000"),backgroundColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"background-color","backgroundColor","#fff")})});a==b&&k.css({padding:"1px",borderTopWidth:"1px",borderLeftWidth:"1px",borderRightWidth:"1px",
borderBottomWidth:"1px",borderTopStyle:"solid",borderLeftStyle:"solid",borderRightStyle:"solid",borderBottomStyle:"solid",borderTopColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"color","color","#000"),borderLeftColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"color","color","#000"),borderRightColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,"color","color","#000"),borderBottomColor:g.telligent.glow.utility.getCurrentStyleValue(c.internal.state,
"color","color","#000")});f.append(k)}}c.internal.popupPanel.glowPopUpPanel("append",d)}},e=function(c,d){if(c){var n=w.val.apply(c.internal.state);if(n===null)n=new Date;n=c.settings.dayIndex>-1?new Date(c.internal.currentYear,c.internal.currentMonth-1,d,n.getHours(),n.getMinutes(),n.getSeconds(),n.getMilliseconds()):new Date(c.internal.currentYear,d,n.getDate(),n.getHours(),n.getMinutes(),n.getSeconds(),n.getMilliseconds());var f=w.val.apply(c.internal.state);if(!f||f.getTime()!=n.getTime()){w.val.apply(c.internal.state,
[n]);c.internal.state.trigger("glowDateTimeSelectorChange")}c.internal.popupPanel.glowPopUpPanel("hide")}};g.fn.glowDateTimeSelector=function(c){if(c in w)return w[c].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof c==="object"||!c)return v.apply(this,arguments);else g.error("Method "+c+" does not exist on jQuery.fn.glowDateTimeSelector")};g.extend(g.fn.glowDateTimeSelector,{defaults:{pattern:"",yearIndex:-1,monthIndex:-1,dayIndex:-1,hourIndex:-1,minuteIndex:-1,amPmIndex:-1,showPopup:true,
...
(function(g){var t=function(w){var x=w.data("_delayedEnterLeaveContextKey");if(x===null||typeof x==="undefined"){x={enterTimeout:null,leaveTimeout:null};w.data("_delayedEnterLeaveContextKey",x)}return x};g.extend(g.event.special,{glowDelayedMouseEnter:{add:function(w){var x=w.data||500,y=function(p){var o=g(this),l=t(o),j=g.extend({},p);l.enterTimeout=setTimeout(function(){j.type="glowDelayedMouseEnter";o.trigger(g.Event("glowDelayedMouseEnter",j));clearTimeout(l.enterTimeout)},x)},v=function(){var p=
t(g(this));clearTimeout(p.enterTimeout)};w.selector?g(document).on("mouseenter",w.selector,y).on("mouseleave",w.selector,v):g(this).on("mouseenter",y).on("mouseleave",v)}},glowDelayedMouseLeave:{add:function(w){var x=w.data||500,y=function(p){var o=g(this),l=t(o),j=g.extend({},p);l.leaveTimeout=setTimeout(function(){j.type="glowDelayedMouseLeave";o.trigger(g.Event("glowDelayedMouseLeave",j));clearTimeout(l.leaveTimeout)},x)},v=function(){var p=t(g(this));clearTimeout(p.leaveTimeout)};w.selector?g(document).on("mouseleave",
w.selector,y).on("mouseenter",w.selector,v):g(this).on("mouseleave",y).on("mouseenter",v)}}})})(jQuery);
(function(g){var t,w={val:function(e){if(e===undefined){var c=this.data("dropDownList");if(c&&c.internal.state&&c.internal.initialized&&c.internal.state.selectedIndex>=0&&c.internal.state.selectedIndex<c.internal.state.options.length)return c.internal.state.options[c.internal.state.selectedIndex].value;return""}else return this.each(function(){var d=g(this).data("dropDownList");if(d.internal.state&&d.internal.initialized){for(var n=0;n<d.internal.state.options.length;n++)if(d.internal.state.options[n].value==
e){w.selectedIndex.apply(g(d.internal.state),[n]);return}w.selectedIndex.apply(g(d.internal.state),[0])}})},selectedIndex:function(e,c){if(e===undefined){var d=this.data("dropDownList");if(d&&d.internal.state&&d.internal.initialized)return d.internal.state.selectedIndex;return-1}else return this.each(function(){var n=g(this).data("dropDownList");if(n.internal.state&&n.internal.initialized&&e>=0&&e<n.internal.items.length&&e<n.internal.state.options.length){var f=n.internal.state.selectedIndex!=e;
...
e.internal.backgroundColor;d.style.borderColor=e.internal.backgroundColor;d.className=""}e.internal.highlightedItemIndex=c};g.fn.glowDropDownList=function(e){if(e in w)return w[e].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof e==="object"||!e)return x.apply(this,arguments);else g.error("Method "+e+" does not exist on jQuery.fn.glowDropDownList")};g.extend(g.fn.glowDropDownList,{defaults:{selectedItemWidth:200,selectedItemHeight:32,itemsWidth:200,itemsHeight:300,itemsHtml:[],showHtmlWhenSelected:true,
...
(function(g,t){var w={val:function(){var c=g(this).data(x);return c!==null&&typeof c.file!=="undefined"&&c.file!==null?{name:c.file.name}:null},destroy:function(){return this.each(function(){var c=g(this).data(x);if(c!==null&&c.pluploader){t.clearTimeout(c.refreshHandle);c.pluploader.destroy()}})}},x="_glowUpload",y={begun:"glowUploadBegun",complete:"glowUploadComplete",error:"glowUploadError",progress:"glowUploadFileProgress",allComplete:"glowUploadsComplete"},v=function(c){return this.each(function(){var d=
g(this),n=g.extend({},g.fn.glowUpload.defaults,c||{},{pluploader:null,file:null,fileOffset:0,fileState:"",isUploading:false,currentUploadPercent:0,fileContainer:null});g.extend(n,{container:d,initialized:false});g(this).data(x,n);n.container.find('input[type="file"]').bind("change",function(){n.container.trigger(y.begun).trigger(y.complete)}).hide();n.renderMode!="link"&&n.renderMode!="dragdrop"&&g("<div></div>").css({fontSize:"11px",borderWidth:"1px",borderStyle:"solid",borderColor:"#999",width:n.width,
overflow:"auto",overflowX:"hidden",backgroundColor:"#eee",textAlign:"center",padding:".25em"}).append(g('<input type="Button" value="Loading..." />').attr("disabled","disabled").css({borderColor:"Transparent",backgroundColor:"Transparent"})).appendTo(n.container);p(n)})},p=function(c){for(var d=["1234567890","0987654321","0192837465","5647382910"],n=[],f=0;f<2500;f++)n[n.length]=d[Math.floor(Math.random()*d.length)];var k=(new Date).getTime();jQuery.ajax({type:"POST",url:c.uploadUrl,data:{test:n.join("")},
success:function(){var a=(new Date).getTime();o(c,2E5/((a-k)/1E3)*45)},error:function(){o(c,1E6)}})},o=function(c,d){if(/Mozilla[^\(]*\(.*? rv:([0-9]+)\.([0-9]+)\.([0-9]+)/.test(navigator.userAgent))if(parseInt(RegExp.$1,10)<1||parseInt(RegExp.$2,10)<9||parseInt(RegExp.$3,10)<2)c.runtimes=c.runtimes.replace(/,?flash/i,"");c.file={name:c.initialFileName,id:"preuploaded"};if(c.file.name&&c.file.name.length>0)c.fileState="uploaded";var n="15mb";if(d<15E6){n=Math.floor(d);if(n<1E6)n=1E6;n=Math.floor(d/
1E6)+"mb"}c.container.attr("id")||c.container.attr("id","upload"+(new Date).getTime());n={runtimes:c.runtimes,container:c.container.attr("id"),url:c.uploadUrl,flash_swf_url:c.swfUrl,silverlight_xap_url:c.silverlightUrl,chunk_size:n,multi_selection:false,drop_element:c.container.attr("id"),browse_button:c.container.attr("id"),filters:{max_file_size:c.maxFileSize}};if(c.fileFilter!==null)n.filters.mime_types=c.fileFilter;if(c.renderMode=="link"||c.renderMode=="dragdrop")n.container=document.body;c.pluploader=
new plupload.Uploader(n);c.pluploader.bind("Init",function(){if(!c.hasInited){c.hasInited=true;if(c.renderMode!="link"&&c.renderMode!="dragdrop"){c.container.children(":not(.moxie-shim)").remove();c.container.addClass("glow-upload");var f=g("<div></div>").css({fontSize:"11px",borderWidth:"1px",borderStyle:"solid",borderColor:"#999",width:c.width,overflow:"auto",overflowX:"hidden",backgroundColor:"#fff"}).appendTo(c.container),k=g("<table></table>").attr("border",0).attr("cellSpacing",0).attr("cellPadding",
0).css({width:"100%"}),a=g("<tbody></tbody>").appendTo(k);a=g("<tr></tr>").appendTo(a);c.fileContainer=g("<td></td>").appendTo(a).css({width:"100%"});a=g("<td></td>").css({backgroundColor:"#eee",borderLeftWidth:"1px",borderLeftStyle:"solid",borderLeftColor:"#999",padding:".25em"}).attr("vAlign","top").appendTo(a);g('<input type="Button" value="'+c.selectFileLabel+'" id="'+c.container.attr("id")+'_browseButton" />').appendTo(a);f.append(k);l(c);c.pluploader.setOption("browse_button",c.container.attr("id")+
"_browseButton")}else if(c.renderMode=="link")c.pluploader.setOption("browse_button",c.container.attr("id"));else{f=g("<div></div>").css({position:"absolute",left:"-10000px",top:"-10000px",height:"1px",width:"1px",overflow:"hidden"}).attr("id",c.container.attr("id")+"_browseButton");c.container.append(f);c.pluploader.setOption("browse_button",f.attr("id"))}c.initialized=true}});c.pluploader.bind("FilesAdded",function(f,k){c.addedFiles=k});c.pluploader.bind("QueueChanged",function(){j(c)});c.pluploader.bind("UploadProgress",
function(f,k){if(!(!k||!c.file||k.id!=c.file.id))if(k.status==plupload.UPLOADING){if(!c.isUploading){var a=!c.isUploading;c.isUploading=true;c.currentUploadPercent=0;l(c);a&&c.container.trigger(y.begun)}c.currentUploadPercent=k.percent;l(c);c.container.trigger(y.progress,{name:k.name,percent:k.percent})}else if(k.status==plupload.FAILED){c.isUploading=false;c.fileState="error";l(c);c.container.trigger("glowUploadError")}});c.pluploader.bind("FileUploaded",function(f,k){c.fileState="uploaded";l(c);
c.container.trigger(y.complete,{name:k.name})});c.pluploader.bind("Error",function(f,k){e(c,k)});c.pluploader.bind("StateChanged",function(){c.pluploader.state==plupload.STOPPED&&c.file!=null&&c.container.trigger(y.allComplete)});t.setTimeout(function(){c.pluploader.init();c.browseButtonPosition={left:0,top:0,width:0,height:0};c.refreshHandle=t.setInterval(function(){try{var f=g(c.pluploader.settings.browse_button);if(f&&f.length>0){var k=f.offset(),a=f.width(),b=f.height();if(c.browseButtonPosition.top!=
k.top||c.browseButtonPosition.left!=k.left||c.browseButtonPosition.width!=a||c.browseButtonPosition.height!=b){c.browseButtonPosition.top=k.top;c.browseButtonPosition.left=k.left;c.browseButtonPosition.width=a;c.browseButtonPosition.height=b;c.pluploader.refresh()}}}catch(h){}},499)},9)},l=function(c){if(c.renderMode!="link"&&c.renderMode!="dragdrop"){var d="";if(c.file)d=c.fileState==="uploaded"?c.uploadedFormat.replace("{0}",c.file.name):c.fileState==="error"?c.errorFormat.replace("{0}",c.file.name):
c.isUploading?c.uploadingFormat.replace("{0}",c.file.name).replace("{1}",c.currentUploadPercent):c.toUploadFormat.replace("{0}",c.file.name);c.fileContainer.html(d)}},j=function(c){if(c.addedFiles){var d=c.addedFiles;c.addedFiles=null;if(d.length!==0){if(c.file){c.isUploading&&c.pluploader.stop();var n=c.file.id;t.setTimeout(function(){if(c.pluploader&&n!="preuploaded")try{c.pluploader.removeFile(c.pluploader.getFile(n))}catch(f){}},99)}c.file=d[0];c.fileState="";l(c);c.file&&c.pluploader.start()}}},
e=function(c,d){if(!c.initialized){var n=c.notSupportedMessage;if(!n){var f=[];c.runtimes.indexOf("html5")>-1&&f.push("An HTML5 capable browser");if(c.runtimes.indexOf("silverlight")>-1)c.renderMode=="link"||c.renderMode=="dragdrop"?f.push("Silverlight"):f.push('<a href="http://microsoft.com/getsilverlight/" target="_blank">Silverlight</a>');if(c.runtimes.indexOf("flash")>-1)c.renderMode=="link"||c.renderMode=="dragdrop"?f.push("Flash"):f.push('<a href="http://get.adobe.com/flashplayer/" target="_blank">Flash</a>');
if(f.length==0)n="Uploading is not supported.";else{if(f.length>1)f[f.length-1]="or "+f[f.length-1];n=f.join(", ")+" is required to upload."}}c.container.children().hide();if(c.renderMode=="link")c.container.bind("click",function(){t.alert(n);return false});else c.renderMode!="dragdrop"&&g("<div></div>").css({fontSize:"11px",borderWidth:"1px",borderStyle:"solid",borderColor:"#999",width:c.width,overflow:"auto",overflowX:"hidden",backgroundColor:"#eee",textAlign:"center",padding:".25em",color:"#000"}).html(n).appendTo(c.container)}if(d.file){c.isUploading=
false;c.fileState="error";l(c);c.container.trigger(y.error)}};g.fn.glowUpload=function(c){if(c in w)return w[c].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof c==="object"||!c)return v.apply(this,arguments);else g.error("Method "+c+" does not exist on jQuery.fn.glowUpload")};g.extend(g.fn.glowUpload,{defaults:{fileFilter:null,maxFileSize:"2048mb",width:"350px",uploadUrl:"/",swfUrl:"plupload.flash.swf",silverlightUrl:"",uploadedFormat:'<div style="overflow: hidden; text-overflow: ellipsis; word-break: break-all; white-space: normal; color: #000; padding: .25em;"><div style="float: right; color: #3a3; margin-left: .25em;">Uploaded</div>{0}</div>',
...
{};q.Value=a;q.SelectedHtml=b;q.SuggestedHtml=h;q.Selectable=m;return q}},w=function(a){return this.each(function(){var b={settings:g.extend({},g.fn.glowLookUpTextBox.defaults,a||{}),internal:{state:this,cursorContainer:null,cursor:null,cursorText:null,lookUpsContainer:null,lookUpsIndex:null,lookUpsIndex:-1,popupPanel:null,lookUps:[],lastCursorValue:null,selectedLookUps:[],mouseIsOverPopup:false,emptyHtmlContainer:null,cursorHasFocus:false,cursorChangeHandler:null,height:18,backgroundColor:"#ffffff",
lineHeight:"100%",initialized:false}};g(this).data("lookUpTextBox",b);x(b)})},x=function(a){if(a.internal.state.offsetHeight){if(a.internal.state.disabled){a.internal.state.disabled=false;a.internal.state.readonly=true}a.internal.backgroundColor=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"background-color","backgroundColor","#ffffff");a.internal.foregroundColor=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"color","color","#000000");a.internal.height=a.internal.state.offsetHeight-
(parseInt(g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"padding-top","paddingTop","0px"),10)+parseInt(g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"padding-bottom","paddingBottom","0px"),10)+parseInt(g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"border-top-width","borderTopWidth","0px"),10)+parseInt(g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"border-bottom-width","borderBottomWidth","0px"),10));if(a.internal.height<=0)a.internal.height=
18;a.internal.lineHeight=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"line-height","lineHeight","100%");a.internal.container=document.createElement("div");a.internal.container.className="glow-lookuptextbox";a.internal.container.style.width=a.internal.state.offsetWidth-(parseInt(g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"padding-left","paddingLeft","0px"),10)+parseInt(g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"padding-right","paddingRight",
"0px"),10)+parseInt(g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"border-left-width","borderLeftWidth","0px"),10)+parseInt(g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"border-right-width","borderRightWidth","0px"),10))+"px";a.internal.container.style.backgroundColor=a.internal.backgroundColor;a.internal.container.style.color=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"color","color","#000000");a.internal.container.style.borderStyle="solid";
...
"content-box"}catch(b){}a.internal.emptyHtmlContainer=document.createElement("div");a.internal.emptyHtmlContainer.style.position="absolute";a.internal.emptyHtmlContainer.style.top="3px";a.internal.emptyHtmlContainer.style.left="3px";a.internal.emptyHtmlContainer.className="glow-lookuptextbox-placeholder";a.internal.emptyHtmlContainer.innerHTML=a.settings.emptyHtml;a.internal.cursorContainer.appendChild(a.internal.emptyHtmlContainer);a.internal.cursor=document.createElement("input");a.internal.cursor.type=
"text";a.internal.cursor.style.backgroundColor=a.internal.backgroundColor;a.internal.cursor.style.fontFamily=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"font-family","fontFamily","Arial, Helvetica");a.internal.cursor.style.fontSize=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"font-size","fontSize","100%");a.internal.cursor.style.lineHeight=a.internal.lineHeight;a.internal.cursor.style.color=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"color",
"color","#000000");a.internal.cursor.style.borderWidth="0px";a.internal.cursor.style.padding="0px";a.internal.cursor.style.height=a.internal.height+"px";a.internal.cursor.style.width="100%";a.internal.cursor.onkeydown=function(u){return _cursorKeyDown(a,u)};a.internal.cursor.onkeyup=function(u){return f(a,u)};a.internal.cursor.onchange=function(u){return f(a,u)};a.internal.cursor.onpaste=function(u){return f(a,u)};a.internal.cursor.onblur=function(u){return _cursorBlur(a,u)};a.internal.cursor.onclick=
function(u){return _containerClick(a,u)};a.internal.cursor.onfocus=function(u){return _cursorFocus(a,u)};a.internal.cursor.tabIndex=a.internal.state.tabIndex;try{a.internal.cursor.style.boxSizing="content-box"}catch(h){}a.internal.cursorContainer.appendChild(a.internal.cursor);if(a.internal.state.id){var m=g('label[for="'+a.internal.state.id+'"]');if(m.length>0){a.internal.cursor.id=a.internal.state.id+"_"+(new Date).getTime();m.each(function(){g(this).attr("for",a.internal.cursor.id)})}}a.internal.container.appendChild(a.internal.cursorContainer);
m=document.createElement("div");m.style.clear="both";a.internal.container.appendChild(m);m=document.createElement("div");a.internal.container.appendChild(m);a.internal.popupPanel=g(m);a.internal.popupPanel.glowPopUpPanel({cssClass:"",position:"updown",zIndex:3E5,hideOnDocumentClick:true}).bind({glowPopUpPanelHidden:function(){a.internal.mouseIsOverPopup=false},glowPopUpPanelMouseOver:function(){_popupMouseOver(a)},glowPopUpPanelMouseOut:function(){_popupMouseOut(a)}});a.internal.popupPanel.glowPopUpPanel("empty");
a.internal.lookUpsContainer=document.createElement("div");a.internal.lookUpsContainer.style.borderStyle="solid";a.internal.lookUpsContainer.style.borderWidth="1px";a.internal.lookUpsContainer.style.borderColor=g(a.internal.state).css("border-color");a.internal.lookUpsContainer.style.height=a.settings.lookUpPopUpHeight+"px";a.internal.lookUpsContainer.style.width=a.internal.state.offsetWidth-4+"px";a.internal.lookUpsContainer.style.overflow="auto";a.internal.lookUpsContainer.style.overflowX="hidden";
a.internal.lookUpsContainer.style.padding="1px";a.internal.lookUpsContainer.style.backgroundColor=a.internal.backgroundColor;a.internal.lookUpsContainer.style.fontFamily=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"font-family","fontFamily","Arial, Helvetica");a.internal.lookUpsContainer.style.fontSize=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,"font-size","fontSize","100%");a.internal.lookUpsContainer.style.lineHeight=g.telligent.glow.utility.getCurrentStyleValue(a.internal.state,
"line-height","lineHeight","100%");a.internal.lookUpsContainer.style.color=a.internal.foregroundColor;try{a.internal.lookUpsContainer.style.boxSizing="content-box"}catch(q){}a.internal.popupPanel.glowPopUpPanel("append",a.internal.lookUpsContainer);try{a.internal.state.type="hidden"}catch(r){}a.internal.state.style.display="none";m=a.internal.state.value.split(a.settings.delimiter);if(m.length==a.settings.selectedLookUpsHtml.length){a.internal.selectedLookUps=[];for(var s=0;s<m.length;s++)a.internal.selectedLookUps[a.internal.selectedLookUps.length]=
t.createLookUp(m[s],a.settings.selectedLookUpsHtml[s],a.settings.selectedLookUpsHtml[s],true)}a.internal.initialized=true;o(a);t.disabled.apply(g(a.internal.state),[a.internal.state.readonly===true])}else window.setTimeout(function(){x(a)},249)},y=function(a){a.internal.lookUpsContainer.style.overflow="hidden";a.internal.lookUpsContainer.style.height=a.settings.lookUpPopUpHeight+"px";a.internal.popupPanel.glowPopUpPanel("show",a.internal.container,a.internal.popupPanel.glowPopUpPanel("isShown"));
window.setTimeout(function(){p(a)},49)},v=function(a){a.internal.popupPanel&&a.internal.popupPanel.glowPopUpPanel("isShown")&&a.internal.popupPanel.glowPopUpPanel("hide")},p=function(a){if(a.internal.popupPanel.glowPopUpPanel("isOpening"))window.setTimeout(function(){p(a)},49);else{try{a.internal.lookUpsContainer.style.overflow="auto";a.internal.lookUpsContainer.style.overflowX="hidden"}catch(b){}a.internal.state.selectedIndex>=0&&_highlightItem(a,a.internal.state.selectedIndex)}},o=function(a){if(a&&
a.internal.initialized){for(;a.internal.lookUpsContainer.childNodes.length>0;)a.internal.lookUpsContainer.removeChild(a.internal.lookUpsContainer.childNodes[0]);if(a.internal.lookUps.length>0){for(var b=a.internal.lookUpsIndex,h=0;h<a.internal.lookUps.length;h++){var m=document.createElement("div");m.onmouseover=g.telligent.glow.utility.makeBoundFunction(c,null,[a,h]);m.onclick=g.telligent.glow.utility.makeBoundFunction(d,null,[a,h]);m.style.padding="2px";m.style.cursor="pointer";g(m).html(a.internal.lookUps[h].SuggestedHtml);
a.internal.lookUpsContainer.appendChild(m)}if(b<0||b>=a.internal.lookUps.length)b=0;c(a,b);y(a)}else v(a)}},l=function(a){for(;a.internal.container.childNodes.length>3;)a.internal.container.removeChild(a.internal.container.childNodes[0]);for(var b=0;b<a.internal.selectedLookUps.length;b++){var h=document.createElement("div");h.style.padding="2px";if(a.settings.maxValues!=1){h.style.cssFloat="left";h.style.styleFloat="left"}var m=document.createElement("div");m.style.borderStyle="solid";m.style.borderColor=
"#bbbbbb";m.style.backgroundColor="#eeeeee";m.style.borderWidth="1px";m.style.padding="2px";m.style.paddingRight="6px";if(t.disabled.apply(g(a.internal.state)))m.style.paddingLeft="6px";m.style.height=a.internal.height+"px";m.style.lineHeight=a.internal.lineHeight;m.style.whiteSpace="nowrap";m.style.cursor="default";m.style.fontFamily=a.internal.cursor.style.fontFamily;m.style.fontSize=a.internal.cursor.style.fontSize;try{m.style.boxSizing="content-box"}catch(q){}if(!t.disabled.apply(g(a.internal.state)))if(a.settings.deleteImageUrl){var r=
document.createElement("img");r.src=a.settings.deleteImageUrl;r.align="top";r.style.padding="4px";r.style.paddingRight="6px";r.style.cursor="pointer";r.onclick=g.telligent.glow.utility.makeBoundFunction(j,null,[a,b]);m.appendChild(r)}else{r=document.createElement("a");r.href="#";r.onclick=g.telligent.glow.utility.makeBoundFunction(j,null,[a,b]);r.style.textDecoration="none";r.style.color="#f00";r.style.fontWeight="bold";r.style.fontSize="80%";r.style.lineHeight=a.internal.lineHeight;r.style.marginLeft=
"4px";r.style.marginRight="6px";r.innerHTML="X";m.appendChild(r)}r=document.createElement("span");r.innerHTML=a.internal.selectedLookUps[b].SelectedHtml;r.style.cursor="default";m.appendChild(r);h.appendChild(m);a.internal.container.insertBefore(h,a.internal.cursorContainer)}if(a.settings.maxValues>0&&a.settings.maxValues==a.internal.selectedLookUps.length){a.internal.container.childNodes[a.internal.container.childNodes.length-2].style.display="none";a.internal.container.childNodes[a.internal.container.childNodes.length-
3].style.display="none"}else{a.internal.container.childNodes[a.internal.container.childNodes.length-2].style.display="inline";a.internal.container.childNodes[a.internal.container.childNodes.length-3].style.display="inline"}},j=function(a,b){t.removeByIndex.apply(g(a.internal.state),[b]);g(a.internal.state).trigger("glowLookUpTextBoxChange");return false},e=function(a,b){if(a.internal.lookUps[b]&&a.internal.lookUps[b].Selectable){if(!a.settings.allowDuplicates)for(var h=0;h<a.internal.selectedLookUps.length;h++)if(a.internal.selectedLookUps[h].Value==
a.internal.lookUps[b].Value)return;a.internal.selectedLookUps[a.internal.selectedLookUps.length]=t.createLookUp(a.internal.lookUps[b].Value,a.internal.lookUps[b].SelectedHtml);a.internal.cursor.value="";v(a);l(a);_save(a);try{a.internal.cursor.focus()}catch(m){}g(a.internal.state).trigger("glowLookUpTextBoxChange")}},c=function(a,b){if(a.internal.lookUps[b]&&a.internal.lookUps[b].Selectable){var h=a.internal.lookUpsContainer.childNodes[b];h.style.backgroundColor=a.internal.foregroundColor;h.style.color=
a.internal.backgroundColor;if(h.offsetTop+h.offsetHeight>a.internal.lookUpsContainer.scrollTop+a.internal.lookUpsContainer.offsetHeight)a.internal.lookUpsContainer.scrollTop=h.offsetTop+h.offsetHeight-a.internal.lookUpsContainer.offsetHeight;else if(h.offsetTop<a.internal.lookUpsContainer.scrollTop)a.internal.lookUpsContainer.scrollTop=h.offsetTop;if(a.internal.lookUpsIndex>=0&&a.internal.lookUpsIndex!=b){h=a.internal.lookUpsContainer.childNodes[a.internal.lookUpsIndex];h.style.backgroundColor=a.internal.backgroundColor;
h.style.color=a.internal.foregroundColor}a.internal.lookUpsIndex=b}},d=function(a,b){e(a,b);return false},n=function(a){if(a.internal.lastCursorValue!=a.internal.cursor.value&&a.internal.cursor.value.length>=a.settings.minimumLookUpLength)f(a);else a.internal.cursorChangeHandler=window.setTimeout(function(){n(a)},149)},f=function(a,b){if(!b)b=window.event;if(a.internal.lastCursorValue!=a.internal.cursor.value){a.internal.cursorChangeHandler&&window.clearTimeout(a.internal.cursorChangeHandler);if(a.settings.maxValues>
0&&a.internal.selectedLookUps.length>=a.settings.maxValues){window.setTimeout(function(){a.internal.cursor.value=""},19);return false}k(a)}return true},k=function(a){a.internal.lastCursorValue=a.internal.cursor.value;if(a.internal.lastCursorValue.length>=a.settings.minimumLookUpLength)a.settings.onGetLookUps&&a.settings.onGetLookUps(g(a.internal.state),a.internal.lastCursorValue);else v(a)};_cursorFocus=function(a){a.internal.emptyHtmlContainer.style.display="none";a.internal.cursorHasFocus=true;
a.internal.cursorChangeHandler=window.setTimeout(function(){n(a)},149);k(a)};_cursorBlur=function(a){a.internal.cursorChangeHandler&&clearTimeout(a.internal.cursorChangeHandler);a.internal.cursorHasFocus=false;window.setTimeout(function(){_cursorBlurComplete(a)},99)};_cursorBlurComplete=function(a){a.internal.cursor.value="";a.internal.lastCursorValue=null;a.internal.mouseIsOverPopup||v(a);if(a.internal.selectedLookUps.length==0&&!a.internal.cursorHasFocus)a.internal.emptyHtmlContainer.style.display=
"block"};_cursorKeyDown=function(a,b){if(!b)b=window.event;if(b.keyCode==8){if(a.internal.selectedLookUps.length>0&&g.telligent.glow.utility.getCurrentCursorIndex(a.internal.cursor)==0){t.removeByIndex.apply(g(a.internal.state),[a.internal.selectedLookUps.length-1]);g(a.internal.state).trigger("glowLookUpTextBoxChange")}return true}else if(b.keyCode==38||b.keyCode==40||b.keyCode==13){if(b.keyCode==38){if(a.internal.popupPanel.glowPopUpPanel("isShown")&&a.internal.lookUpsIndex>0)for(var h=false,m=
a.internal.lookUpsIndex-1;m>=0&&!h;m--)if(a.internal.lookUps[m].Selectable){c(a,m);h=true}}else if(b.keyCode==40){if(a.internal.popupPanel.glowPopUpPanel("isShown")&&a.internal.lookUpsIndex<a.internal.lookUps.length-1){h=false;for(m=a.internal.lookUpsIndex+1;m<a.internal.lookUps.length&&!h;m++)if(a.internal.lookUps[m].Selectable){c(a,m);h=true}}}else if(b.keyCode==13)if(a.internal.popupPanel.glowPopUpPanel("isShown")&&a.internal.lookUpsIndex>=0)e(a,a.internal.lookUpsIndex);else{a.internal.cursor.value=
"";a.internal.lastCursorValue=""}b.cancelBubble=true;b.preventDefault&&b.preventDefault();b.stopProgagation&&b.stopPropagation();return false}else if(b.keyCode==9)if(a.internal.popupPanel.glowPopUpPanel("isShown")&&a.internal.lookUpsIndex>=0)e(a,a.internal.lookUpsIndex);else{a.internal.cursor.value="";a.internal.lastCursorValue=""}else if(a.settings.maxValues>0&&a.internal.selectedLookUps.length>=a.settings.maxValues){b.cancelBubble=true;b.preventDefault&&b.preventDefault();b.stopProgagation&&b.stopPropagation();
return false}return true};_containerClick=function(a){a.internal.emptyHtmlContainer.style.display="none";try{a.internal.cursor.focus()}catch(b){}return false};_save=function(a){for(var b=[],h=0;h<a.internal.selectedLookUps.length;h++)b[b.length]=a.internal.selectedLookUps[h].Value;a.internal.state.value=b.join(a.settings.delimiter)};_popupMouseOver=function(a){a.internal.mouseIsOverPopup=true};_popupMouseOut=function(a){a.internal.mouseIsOverPopup=false};g.fn.glowLookUpTextBox=function(a){if(a in
t)return t[a].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof a==="object"||!a)return w.apply(this,arguments);else g.error("Method "+a+" does not exist on jQuery.fn.glowLookUpTextBox")};g.extend(g.fn.glowLookUpTextBox,{defaults:{delimiter:",",allowDuplicates:false,maxValues:0,onGetLookUps:null,emptyHtml:"",selectedLookUpsHtml:[],deleteImageUrl:"",lookUpPopUpHeight:200,minimumLookUpLength:1}})})(jQuery);
(function(g,t){var w=function(l,j){var e={},c={};if(l&&g.isPlainObject(l)){e=g.extend({},g.glowModal.defaults,l||{});c=g.extend({},l||{})}else{e=g.extend({},g.glowModal.defaults,j||{},{url:l});c=g.extend({},j||{},{url:l})}if(!e.openerWindow){e.openerWindow=t;c.openerWindow=t}var d=v(e.openerWindow);if(d)return d.$.glowModal(c);c=null;for(d=x.length-1;d>=0;d--)if(x[d].shown())break;else c=x[d];if(!c){x[x.length]=new o("telligent_modal_"+x.length);c=x[x.length-1]}return c.open(e)};g.extend(w,{defaults:{width:300,
...
j);else(e=p(j))&&e.close(l)},moveTo:function(l,j,e){e||(e=t);var c=v(e);if(c)c.$.glowModal.moveTo(l,j,e);else(e=p(e))&&e.moveTo(l,j)},resize:function(l,j,e,c){c||(c=t);var d=v(c);if(d)d.$.glowModal.resize(l,j,e,c);else(c=p(c))&&c.resize(l,j,e)},refresh:function(l){l||(l=t);var j=v(l);j?j.$.glowModal.refresh(l):g.each(x,function(e,c){c.refresh()})},opener:function(l,j){j||(j=t);var e=v(j);if(e)return e.$.glowModal.opener(l,j);e=y(x,function(c){return c.shown()&&c._modalIframe.contentWindow==l});return e!==
null?e._openerWindow:null},visible:function(l){l||(l=t);var j=v(l);if(j)return j.$.glowModal.shown(l);return(l=p(l))?l.shown():false}});g.extend({glowModal:w});var x=[],y=function(l,j){var e=g.grep(l,j);return e!==null&&e.length>0?e[e.length-1]:null},v=function(){if(w.defaults.openInParentModal)try{if(t.parent&&t.parent!=t&&parent.$&&parent.$.glowModal)return t.parent}catch(l){}return null},p=function(l){return y(x,function(j){return j.shown()&&j._openerWindow==l})},o=function(l){this._id=l;this._initialized=
...
m.name=a.text;m.value=a.value;h.internal.state.appendChild(m);g(h.internal.state).trigger(w.itemAdded,m)})},remove:function(a){if(!a)return this;return this.each(function(){for(var b=g(this).data("orderedList"),h=[],m=false,q=0;q<b.internal.items.length;q++)if(b.internal.items[q].value==a.value)m=true;else h[h.length]=b.internal.items[q];for(q=0;q<b.internal.state.options.length;q++)if(b.internal.state.options[q].value==a.value){b.internal.state.removeChild(b.internal.state.options[q]);break}g(b.internal.state).trigger(w.itemRemoved,
...
(function(g){var t=function(j){return this.each(function(){var e={settings:g.extend({},g.fn.glowPatternedTextBox.defaults,j||{}),internal:{state:g(this),patterns:[],initialized:false,matchRE:null,delayedValue:null,cursorSetTimeout:null}};g(this).data("_glowPatternedTextBox",e);var c=e.settings.pattern;if(e.internal.state){var d=e.internal.state.val();e.internal.state.addClass(e.settings.cssClass);for(var n=RegExp("<([^<>]{1,}?)>","ig"),f,k=0,a="^";f=n.exec(c);){if(f.index>k){e.internal.patterns[e.internal.patterns.length]=
new l(c.substr(k,f.index-k),e.settings.blankCharacter,e.settings.allowBlanks,true);a+="("+e.internal.patterns[e.internal.patterns.length-1].getRegExpPattern()+")"}e.internal.patterns[e.internal.patterns.length]=new l(f[1],e.settings.blankCharacter,e.settings.allowBlanks,false);a+="("+e.internal.patterns[e.internal.patterns.length-1].getRegExpPattern()+")";k=n.lastIndex}if(k<c.length){e.internal.patterns[e.internal.patterns.length]=new l(c.substr(k,c.length-k),e.settings.blankCharacter,e.settings.allowBlanks,
true);a+="("+e.internal.patterns[e.internal.patterns.length-1].getRegExpPattern()+")"}a+="$";e.internal.state.is("input:disabled")?o.disabled.apply(e.internal.state,[true]):o.disabled.apply(e.internal.state,[false]);e.internal.matchRE=RegExp(a,"i");e.internal.initialized=true;o.val.apply(e.internal.state,[d])}})},w=function(j){j.internal.state.trigger("glowPatternedTextBoxChange")},x=function(j,e){for(var c=0,d=0;d<j.internal.patterns.length;d++)if(!j.internal.patterns[d].isStatic())if(c==e)return j.internal.patterns[d];
...
d<=n.currentPatternEndIndex?g.telligent.glow.utility.setCurrentCursorSelection(c.internal.state,d,n.currentPatternEndIndex,true):g.telligent.glow.utility.setCurrentCursorSelection(c.internal.state,n.currentPatternStartIndex,n.currentPatternEndIndex,true);else g.telligent.glow.utility.setCurrentCursorSelection(c.internal.state,d,d,true);w(c)}}else d.stopPropagation()}).bind("focus.glowPatternedTextBox",function(d){d=d.shiftKey?y(c,c.internal.state.val().length):y(c,0);d.currentPattern&&g.telligent.glow.utility.setCurrentCursorSelection(c.internal.state,
d.currentPatternStartIndex,d.currentPatternEndIndex,false)}).bind("keydown.glowPatternedTextBox",function(d){p(c,d)}).bind("change.glowPatternedTextBox",function(){if(c.internal.initialized){o.val.apply(c.internal.state,[c.internal.state.val()]);w(c)}}).removeAttr("disabled")}})}},l=function(j,e,c,d){this._maxLength=this._minLength=0;this._options=[];this._rangeEnd=this._rangeStart=0;this._currentValue=this._patternType="";this._placeholder=e;this._allowBlanks=c;if(d){this._patternType="static";this._minLength=
...
function(j){if(j in o)return o[j].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof j==="object"||!j)return t.apply(this,arguments);else g.error("Method "+j+" does not exist on jQuery.fn.glowPatternedTextBox")};g.extend(g.fn.glowPatternedTextBox,{defaults:{pattern:"",allowBlanks:true,blankCharacter:"_",onValidation:null,cssClass:"glow-patternedtextbox"}})})(jQuery);
(function(g){var t={opened:"glowPopUpMenuOpened",closed:"glowPopUpMenuClosed",itemOver:"glowPopUpMenuItemOver"},w=function(f){return this.each(function(){var k={settings:g.extend({},g.fn.glowPopUpMenu.defaults,f||{}),internal:{state:this,menuItems:[],menuLevels:[],initialized:false,currentLevel:-1,isOpen:false,cancelClick:false,openingElement:null,closeTimeout:null}};g(this).data("popUpMenu",k);x(k,k.settings.menuItems,null)})},x=function(f,k){this._menuItems=[];if(!(!k||k.length==0))for(var a=0;a<
...
e.internal.lastPosition.Y,e.internal.lastPosition.Width,e.internal.lastPosition.Height,true])})}};g.fn.glowPopUpPanel=function(e){if(e in j)return j[e].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof e==="object"||!e)return x.apply(this,arguments);else g.error("Method "+e+" does not exist on jQuery.fn.glowPopUpPanel")};g.extend(g.fn.glowPopUpPanel,{defaults:{cssClass:"",position:"updown",zIndex:100,hideOnDocumentClick:true,hideOnResize:true}})})(jQuery,window);
...
if(n)return n.internal.selectedTab;return null}else{if(!d)return this;return this.each(function(){var f=g(this).data("tabSet"),k=t.getById.apply(g(this),[d.id]);k&&l(f,k)})}},createTab:function(d){return new e(d)}},w=function(d){return this.each(function(){var n={settings:g.extend({},g.fn.glowTabSet.defaults,d||{}),internal:{state:this,selectedTab:null,selectedTabRow:null,tabs:[],tabRows:[],resizeCheckHandle:null,isRendered:false,previousContainerOffsetWidth:-1}};g(this).data("tabSet",n);x(n,n.settings.tabs,
null);n.internal.tabs.length>0&&t.refresh.apply(g(this))})},x=function(d,n,f){if(typeof f=="undefined"&&d.internal.selectedTab)f=d.internal.selectedTab.id;d.internal.tabs=[];if(!(!n||n.length==0))for(var k=0;k<n.length;k++){d.internal.tabs[k]=new e({id:n[k][0],text:n[k][1],url:n[k][2],onClick:n[k][3],cssClass:n[k][4]});d.internal.tabs[k]._tabSet=this;if(d.internal.tabs[k].id==f)d.internal.selectedTab=d.internal.tabs[k]}},y=function(d){for(var n=0;n<d.internal.tabRows.length;n++)if(d.internal.tabRows[n]&&
...
g(d.internal.state).trigger("glowTabSetResize")}d.internal.resizeCheckHandle=window.setTimeout(function(){j(d)},999)};g.fn.glowTabSet=function(d){if(d in t)return t[d].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof d==="object"||!d)return w.apply(this,arguments);else g.error("Method "+d+" does not exist on jQuery.fn.glowTabSet")};g.extend(g.fn.glowTabSet,{defaults:{cssClass:"",tabCssClasses:[],tabSelectedCssClasses:[],tabHoverCssClasses:[],enableResizing:true,tabs:[]}});var e=
...
(function(g){var t=[],w=[],x=function(p,o){for(var l=null,j=-1,e=0;e<t.length&&l===null;e++)if(t[e]){if(t[e].SelectElement==o)l=t[e]}else j=e;if(l===null){l={};l.SelectElement=o;l.ElementsHidingSelectsIndeces=[];l.OriginalVisibility=o.style.visibility;l.SelectElement.style.visibility="hidden";if(j==-1){t[t.length]=l;l.Index=t.length-1}else{t[j]=l;l.Index=j}}j=false;for(e=0;e<l.ElementsHidingSelectsIndeces.length&&!j;e++)if(l.ElementsHidingSelectsIndeces[e]==p.Index)j=true;if(!j){p.HiddenSelectsIndeces[p.HiddenSelectsIndeces.length]=
l.Index;l.ElementsHidingSelectsIndeces[l.ElementsHidingSelectsIndeces.length]=p.Index}},y=function(p){for(var o=null,l=-1,j=0;j<w.length&&o===null;j++)if(w[j]){if(w[j].Element==p)o=w[j]}else l=j;if(o===null){o={};o.Element=p;o.HiddenSelectsIndeces=[];if(l==-1){w[w.length]=o;o.Index=w.length-1}else{w[l]=o;o.Index=l}}return o},v={convertHsvColorToRgbColor:function(p){var o=p[0],l=p[1];p=p[2];var j,e,c;if(l===0)return[p,p,p];var d;d=o==360?0:o;d/=60;o=Math.floor(d);var n=d-o;d=p*(1-l);var f=p*(1-l*n);
...
d=0;d<c.length;d++)if(!v.elementContainsElement(p,c[d]))try{v.hideElementsInWindow(p,c[d].contentWindow,l)}catch(n){o=v.getElementInfo(c[d]);if(l||o.Top<e.Bottom&&e.Top<o.Bottom&&o.Left<e.Right&&e.Left<o.Right){if(j===null)j=y(p);x(j,c[d]);c[d].style.visibility="hidden"}}c=["object","embed","applet"];if(v.isIE())c[c.length]="select";for(d=0;d<c.length;d++)for(var f=document.getElementsByTagName(c[d]),k=0;k<f.length;k++)if(!v.elementContainsElement(p,f[k])){o=v.getElementInfo(f[k]);if(l||o.Top<e.Bottom&&
e.Top<o.Bottom&&o.Left<e.Right&&e.Left<o.Right){if(j===null)j=y(p);x(j,f[k]);f[k].style.visibility="hidden"}}},hideSelectBoxes:function(p,o){if(p instanceof jQuery)p=p.get(0);v.hideElementsInWindow(p,window.window,o)},showSelectBoxes:function(p){if(p instanceof jQuery)p=p.get(0);for(var o=null,l=0;l<w.length&&o===null;l++)if(w[l])if(w[l].Element==p)o=w[l];if(o!==null){for(l=0;l<o.HiddenSelectsIndeces.length;l++)if(p=t[o.HiddenSelectsIndeces[l]])if(p.ElementsHidingSelectsIndeces.length==1){try{if(p.SelectElement.style.visibility==
"hidden")p.SelectElement.style.visibility=p.OriginalVisibility}catch(j){}t[p.Index]=null}else{for(var e=[],c=0;c<p.ElementsHidingSelectsIndeces.length;c++)if(p.ElementsHidingSelectsIndeces[c]!=o.Index)e[e.length]=p.ElementsHidingSelectsIndeces[l];p.ElementsHidingSelectsIndeces=e}w[o.Index]=null}},makeBoundFunction:function(p,o,l){return function(){return p.apply(o,l)}}};if(typeof g.telligent==="undefined")g.telligent={};if(typeof g.telligent.glow==="undefined")g.telligent.glow={};if(typeof g.telligent.glow.utility===
"undefined")g.telligent.glow.utility=v})(jQuery);
(function(g){g.fn.glowTransition=function(t,w){var x=g(t).hide(),y=g.extend({},g.fn.glowTransition.defaults,w||{});return this.each(function(){var v=g(this),p={width:v.outerWidth(),height:v.outerHeight(),left:v.css("left"),top:v.css("top"),position:"relative",overflow:"hidden"},o={rawWidth:x.width(),rawHeight:x.height(),width:x.outerWidth(),height:x.outerHeight()};v.wrap(g("<div></div>").css(p)).css({position:"absolute"});var l=v.parent(),j={position:"absolute"},e={},c={};if(y.resize){g.extend(j,
{width:p.width,height:p.height});g.extend(e,{width:o.width,height:o.height});g.extend(c,{width:o.rawWidth,height:o.rawHeight})}switch(y.type){case "slideLeft":j.left="+"+o.width+"px";e.left="-="+o.width;c.left=0;break;case "slideRight":j.left="-"+o.width+"px";e.left="+="+o.width;c.left=0;break;case "slideUp":j.top="+"+o.height+"px";e.top="-="+o.height;c.top=0;break;case "slideDown":j.top="-"+o.height+"px";e.top="+="+o.height;c.top=0;break;case "fade":j.opacity=0;e.opacity=0;c.opacity=1}x.prependTo(l).css(j).show();
v.stop().animate(e,y.duration);x.stop().animate(c,y.duration+1,function(){x.css({position:"static",top:"0px",left:"0px"}).unwrap();v.remove();y.complete()});l.stop().animate({width:o.width,height:o.height},y.duration)})};g.fn.glowTransition.defaults={complete:function(){},duration:200,resize:true,type:"fade"}})(jQuery);
(function(g){var t={nodeSelected:"glowTreeNodeSelected",contextMenu:"glowTreeContextMenu",nodeRemoved:"glowTreeNodeRemoved",nodeMoved:"glowTreeNodeMoved",nodeAdded:"glowTreeNodeAdded"},w=function(b){return this.each(function(){var h={settings:g.extend({},g.fn.glowTree.defaults,b||{}),internal:{state:this,wrapper:null,container:null,selectedNode:null,nodes:[],backgroundColor:null,movingNode:null,movingNodeStartParent:null,draggingInitialized:false,pagePosition:null,movingNodeIsFloating:false,movingNodeFloat:null,
nodeHeightsCache:null,movingNodeStartIndex:null,movingNodeLastIndex:null,moveStartY:null,moveScrollStartY:null,draggableTrees:[],initialized:false}};g(this).data("tree",h);o(h)})},x=function(b,h){for(var m=0;m<b.internal.nodes.length;m++)b.internal.nodes[m]._setCursor(h);b.internal.wrapper.style.cursor=h},y=function(b,h,m,q){b.internal.pagePosition==null&&d(b);var r=b.internal.pagePosition.Left,s=b.internal.pagePosition.Left+b.internal.pagePosition.Width,u=b.internal.pagePosition.Top;b=b.internal.pagePosition.Top+
...
m+q>b.internal.wrapper.scrollTop+r)b.internal.wrapper.scrollTop=m},e=function(b){b.internal.draggableTrees=[];b.settings.draggableTrees&&b.settings.draggableTrees.each(function(){try{if(g(this).glowTree("disabled")===false)b.internal.draggableTrees[b.internal.draggableTrees.length]=g(this)}catch(h){}})},c=function(b){d(b);e(b);var h;for(h=0;h<b.internal.draggableTrees.length;h++)b.internal.draggableTrees[h].glowTree("highlight",true);b.internal.draggableTrees.length>0?x(b,"move"):x(b,"n-resize");
...
m.internal.nodes[r]._element.offsetHeight){if(m=m.internal.nodes[r]._getParentAndIndex(h))if(m.moveNext)q.index++;else q=m;break}else{h-=m.internal.nodes[r]._element.offsetHeight;q.index++}}return q},highlight:function(b){return this.each(function(){var h=g(this).data("tree");if(b){for(var m=0;m<h.internal.nodes.length;m++)h.internal.nodes[m]._highlight();g(h.internal.wrapper).addClass("glow-tree-highlighted");h.internal.wrapper.style.backgroundColor="#cccccc";h.internal.wrapper.style.borderColor=
"#666666";d(h)}else{for(m=0;m<h.internal.nodes.length;m++)h.internal.nodes[m]._unhighlight();g(h.internal.wrapper).removeClass("glow-tree-highlighted");h.internal.wrapper.style.backgroundColor=h.internal.backgroundColor;h.internal.wrapper.style.borderColor="#999999"}})},addDraggedNode:function(b,h,m,q){var r=this.data("tree");if(r){if(!q)q=window.event;if(h){h.insert(b,m);h.refresh()}else{k.insert.apply(g(r.internal.state),[b,m]);k.refresh.apply(g(r.internal.state),[])}g(r.internal.state).trigger(t.nodeAdded,
[b]);k.selected.apply(g(r.internal.state),[b]);n(r,q,b);c(r)}return this},selected:function(b){if(b===undefined){var h=this.data("tree");if(h)return h.internal.selectedNode}else return this.each(function(){var m=g(this).data("tree"),q=k.getByValue.apply(g(this),[b.value]);if(q){var r=m.internal.selectedNode;if(m.internal.selectedNode&&m.internal.selectedNode._element){g(m.internal.selectedNode._element).removeClass("glow-tree-node-selected");m.internal.selectedNode._element.childNodes[1].style.backgroundColor=
m.internal.backgroundColor}if(q._element){g(q._element).addClass("glow-tree-node-selected");q._element.childNodes[1].style.backgroundColor="#ccc";m.internal.selectedNode=q;j(m,q);r!=q&&g(m.internal.state).trigger(t.nodeSelected,[m.internal.selectedNode])}else m.internal.selectedNode=null}})},resize:function(b,h){if(b<=4)b=4;if(h<=4)h=4;return this.each(function(){var m=g(this).data("tree");m.internal.wrapper.style.width=b-4+"px";m.internal.wrapper.style.height=h-4+"px"})},disabled:function(b){if(b===
undefined){var h=this.data("tree");if(h)return h.internal.state.readonly}else return this.each(function(){var m=g(this).data("tree");m.internal.state.readonly=b;k.refresh.apply(g(m.internal.state),[])})},refresh:function(){return this.each(function(){var b=g(this).data("tree");if(b.internal.initialized){for(;b.internal.container.childNodes.length>0;)b.internal.container.removeChild(b.internal.container.childNodes[0]);for(var h=0;h<b.internal.nodes.length;h++){b.internal.nodes[h]._dispose(true);b.internal.nodes[h].refresh()}b.internal.selectedNode&&
k.selected.apply(g(b.internal.state),[b.internal.selectedNode])}})},add:function(b){if(!b)return this;k.remove.apply(this,[b]);var h=true;return this.each(function(){if(h)h=false;else b=b._clone();var m=g(this).data("tree");b._parent=null;b._treeContext=m;m.internal.nodes[m.internal.nodes.length]=b})},remove:function(b){if(b)return this.each(function(){var h=g(this).data("tree"),m=k.getByValue.apply(g(h.internal.state),[b.value]);if(m)if(m.getParent()==null){for(var q=[],r=false,s=0;s<h.internal.nodes.length;s++)if(h.internal.nodes[s]==
m)r=true;else q[q.length]=h.internal.nodes[s];if(r){m._dispose();h.internal.nodes=q}}else m.getParent()._remove(m)})},insert:function(b,h){if(!b)return this;k.remove.apply(this,[b]);var m=true;return this.each(function(){if(m)m=false;else b=b._clone();var q=g(this).data("tree");if(h<0||h>=q.internal.nodes.length)h=q.internal.nodes.length;for(var r=q.internal.nodes.length;r>h;r--)q.internal.nodes[r]=q.internal.nodes[r-1];b._parent=null;b._treeContext=q;q.internal.nodes[h]=b})},getByValue:function(b){var h=
this.data("tree");if(h)for(var m,q=0;q<h.internal.nodes.length;q++)if(h.internal.nodes[q].value==b)return h.internal.nodes[q];else if((m=h.internal.nodes[q].getByValue(b))!=null)return m;return null},getIndex:function(b){var h=this.data("tree");if(h){for(var m=0;m<h.internal.nodes.length;m++)if(h.internal.nodes[m]==b)return m;return-1}},getByIndex:function(b){var h=this.data("tree");if(h&&b<h.internal.nodes.length&&b>=0)return h.internal.nodes[b]},count:function(){var b=this.data("tree");if(b)return b.internal.nodes.length},
createTreeNode:function(b){return new a(b)}};g.fn.glowTree=function(b){if(b in k)return k[b].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof b==="object"||!b)return w.apply(this,arguments);else g.error("Method "+b+" does not exist on jQuery.fn.glowTree")};g.extend(g.fn.glowTree,{defaults:{enableDragDrop:false,getSubNodes:null,canHaveChildren:null,nodeHtml:[],draggableTrees:"",expandedImageUrl:"",collapsedImageUrl:"",blankImageUrl:""}});var a=function(b){var h={value:(new Date).getTime(),
html:""};b&&g.extend(h,b);this.html=h.html;this.value=h.value;this._parent=null;this._canHaveChildren=true;this._isLoaded=this._isExpanded=false;this._element=this._treeContext=null;this._nodes=[]};a.prototype._clone=function(){for(var b=new a({value:this.value,html:this.html}),h=0;h<this._nodes.length;h++)b.add(this._nodes[h]._clone());return b};a.prototype.add=function(b){b._parent=this;b._treeContext=this._treeContext;this._nodes[this._nodes.length]=b};a.prototype._dispose=function(b){this._element=
null;if(!b)for(b=0;b<this._nodes.length;b++)this._nodes[b]._dispose()};a.prototype.refresh=function(){var b,h,m=false;this._element||(m=true);if(m){this._dispose();b=document.createElement("li");b.style.margin="0";b.style.padding="0";b.className="glow-tree-node";b.onselectstart=function(){return false};try{b.style.MozUserSelect="none"}catch(q){}try{b.style.userSelect="none"}catch(r){}try{b.style.WebkitUserSelect="ignore"}catch(s){}}else b=this._element;for(;b.childNodes.length>0;)b.removeChild(b.childNodes[0]);
b.appendChild(document.createElement("img"));b.appendChild(document.createElement("span"));b.childNodes[1].innerHTML=this.html;if(!k.disabled.apply(g(this._treeContext.internal.state))){b.childNodes[1].onclick=g.telligent.glow.utility.makeBoundFunction(k.selected,g(this._treeContext.internal.state),[this]);var u=this;if(this._treeContext.settings.enableDragDrop)b.childNodes[1].onmousedown=function(z){n(u._treeContext,z,u)};b.childNodes[1].oncontextmenu=function(){g(u._treeContext.internal.state).trigger(t.contextMenu,
[void 0,u])}}this._element=b;if(this._treeContext.internal.selectedNode==this){g(this._element).addClass("glow-tree-node-selected");this._element.childNodes[1].style.backgroundColor="#ccc"}if(this._nodes.length>0){this._isLoaded=true;b.childNodes[0].src=this._isExpanded?this._treeContext.settings.expandedImageUrl:this._treeContext.settings.collapsedImageUrl;if(k.disabled.apply(g(this._treeContext.internal.state)))b.childNodes[0].style.cursor="default";else{b.childNodes[0].style.cursor="pointer";var A=
this;b.childNodes[0].onclick=function(){A.expanded(!A._isExpanded,true)}}if(this._isExpanded){h=document.createElement("ul");h.style.listStyleType="none";h.style.margin="0";h.style.padding="0";h.style.paddingLeft="16px";b.appendChild(h);for(h=0;h<this._nodes.length;h++){this._nodes[h]._dispose(true);this._nodes[h]._parent=this;this._nodes[h]._treeContext=this._treeContext;this._nodes[h].refresh()}}}else if(this._isLoaded||this._isExpanded||!this._treeContext.settings.getSubNodes){b.childNodes[0].src=
this._treeContext.settings.blankImageUrl;b.childNodes[0].style.cursor="default"}else{b.childNodes[0].src=this._isExpanded?this._treeContext.settings.expandedImageUrl:this._treeContext.settings.collapsedImageUrl;if(k.disabled.apply(g(this._treeContext.internal.state)))b.childNodes[0].style.cursor="default";else{b.childNodes[0].style.cursor="pointer";A=this;b.childNodes[0].onclick=function(){A.expanded(!A._isExpanded,true)}}}if(m)this._parent?this._parent._element.childNodes[2].appendChild(b):this._treeContext.internal.container.appendChild(b)};
a.prototype._getParentAndIndex=function(b){if(b>this._element.childNodes[1].offsetHeight/2&&(this._nodes.length==0||!this._isExpanded)){var h={};h.moveNext=true;return h}b-=this._element.childNodes[1].offsetHeight;if(b<0||this._nodes.length==0||!this._isExpanded)return null;else{h={};h.parentNode=this;h.index=0;h.moveNext=false;for(var m=0;m<this._nodes.length;m++)if(this._nodes[m]._element)if(b<this._nodes[m]._element.offsetHeight){if(b=this._nodes[m]._getParentAndIndex(b))if(b.moveNext)h.index++;
else h=b;break}else{b-=this._nodes[m]._element.offsetHeight;h.index++}return h}};a.prototype._highlight=function(){if(this._element){g(this._element).addClass("glow-tree-node-highlighted");this._element.style.backgroundColor="#cccccc";if(this._isExpanded)for(var b=0;b<this._nodes.length;b++)this._nodes[b]._highlight()}};a.prototype._unhighlight=function(){if(this._element){g(this._element).removeClass("glow-tree-node-highlighted");this._element.style.backgroundColor=this._treeContext.internal.backgroundColor;
if(this._isExpanded)for(var b=0;b<this._nodes.length;b++)this._nodes[b]._unhighlight()}};a.prototype._setCursor=function(b){if(this._element){this._element.style.cursor=b;if(this._isExpanded)for(var h=0;h<this._nodes.length;h++)this._nodes[h]._setCursor(b)}};a.prototype.expanded=function(b,h){if(b===undefined)return this._isExpanded;else{this._isExpanded=b?true:false;if(this._treeContext){if(this._element&&this._element.childNodes.length==3){this._element.childNodes[2].style.display=this._isExpanded?
